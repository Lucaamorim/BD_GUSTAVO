...
CREATE TABLE IF NOT EXISTS RECEBIMENTOS(
    cod_pedido_r INT NOT NULL, 
    data_receb DATE NOT NULL,
    hora_receb TIME NOT NULL,
    quant_prod_receb INT NOT NULL,
    condic_mat_receb VARCHAR (50) NOT NULL,
    CONSTRAINT fk_cod_pedido_r FOREIGN KEY (cod_pedido_r) REFERENCES PEDIDOS(cod_ped), 
    PRIMARY KEY (cod_pedido_r, data_receb, hora_receb) 
);
...
CREATE TABLE IF NOT EXISTS PEDIDO_PROD(
    ...
    CONSTRAINT fk_cod_pedido_pp FOREIGN KEY (cod_pedido_pp) REFERENCES PEDIDOS(cod_ped), 
...
CREATE TABLE IF NOT EXISTS PROD_FILIAL(
    ...
    CONSTRAINT fk_cod_filial_pf FOREIGN KEY (cod_filial_pf) REFERENCES FILIAIS(cod_filial),
